...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=IAMTHAIS\\SQLEXPRESS01;Initial Catalog=FINALASS_FPOLYSHOP_FA22_SOF205__SOF2041;Persist Security Info=True;User ID=thaitdph26029;Password=tranduythai010305");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ChucVu>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__ChucVu__3214CC9EDC08E619")
                    .IsUnique();
            ...
            modelBuilder.Entity<CuaHang>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__CuaHang__3214CC9EF88A12DE")
                    .IsUnique();
            ...
            modelBuilder.Entity<DongSp>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__DongSP__3214CC9EA4B76CD7")
                    .IsUnique();
            ...
            modelBuilder.Entity<GioHang>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__GioHang__3214CC9E7D8911BD")
                    .IsUnique();
            ...
            modelBuilder.Entity<HoaDon>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__HoaDon__3214CC9EBA613DA1")
                    .IsUnique();
            ...
            modelBuilder.Entity<KhachHang>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__KhachHan__3214CC9E214287B2")
                    .IsUnique();
            ...
            modelBuilder.Entity<MauSac>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__MauSac__3214CC9E03C7B04D")
                    .IsUnique();
            ...
            modelBuilder.Entity<NhanVien>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__NhanVien__3214CC9E1C66978A")
                    .IsUnique();
            ...
            modelBuilder.Entity<Nsx>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__NSX__3214CC9E4DC2CE4E")
                    .IsUnique();
            ...
            modelBuilder.Entity<SanPham>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__SanPham__3214CC9E6DEEC4CA")
                    .IsUnique();
